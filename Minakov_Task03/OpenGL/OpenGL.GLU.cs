...
namespace Minakov_Task03
{
    ...
    {
        // https://stackoverflow.com/questions/24758386/intptr-to-callback-function
        /**** Generic constants****/
        ...
        private static extern IntPtr glu_ErrorString(uint errCode);
        public static string gluErrorString(uint name)
        {
            IntPtr ca = glu_ErrorString(name);
            return Marshal.PtrToStringAnsi(ca);
        }

        [DllImport(GLU_DLL, EntryPoint = "gluGetString")]
        private static extern IntPtr glu_GetString(uint name);
        public static string gluGetString(uint name)
        {
            IntPtr ca = glu_GetString(name);
            return Marshal.PtrToStringAnsi(ca);
        }
        ...
        //LPA public static extern int gluProject(double objx, double objy, double objz, double modelMatrix, double projMatrix, int viewport, ref double winx, ref double winy, ref double winz);
        ...
        // LPA public static extern int gluUnProject(double winx, double winy, double winz, double modelMatrix, double projMatrix, int viewport, ref double objx, ref double objy, ref double objz);
