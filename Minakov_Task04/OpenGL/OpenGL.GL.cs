...
namespace Minakov_Task04
{
    public partial class OpenGL
    {
        ...
        public const string USER_DLL = "user32.dll";
        ...
        private static extern IntPtr gl_GetString(uint name);
        public static string glGetString(uint name)
        {
            IntPtr ca = gl_GetString(name);
        ...
        public static extern void glReadPixels(int x, int y, int width, int height, uint format, uint type, out double value);
        [DllImport(GL_DLL, EntryPoint = "glReadPixels")]
